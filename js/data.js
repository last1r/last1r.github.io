...
const portfolio = {
  ...
  photo: "assets/images/portrait/portrait-main.webp",
  ...
  education: {
    ...
    // Снимки кампуса живут внутри карточки образования: образование —
    // часть профиля разработчика, а не отдельная галерея.
    photos: [
      {
        src: "assets/images/university/university-night.webp",
        w: 1600, h: 671,
        alt: "Ночной вид на корпус Университета «Сириус» с подсвечённой вывеской",
        tag: "КАМПУС · ВЕЧЕР",
      },
      {
        src: "assets/images/university/university-mountains.webp",
        w: 760, h: 505,
        alt: "Дневной корпус Университета «Сириус» на фоне гор Сочи",
        tag: "КАМПУС · ГОРЫ",
      },
    ],
  },
    ...
    items: [
      {
        ...
        visual: "ai",
        shot: {
          src: "assets/images/studymate/studymate-chat.webp",
          w: 560, h: 759,
          alt: "StudyMate — экран Telegram-чата: тест по русскому языку для 8 класса, вопрос и варианты ответа",
        },
        // Слайд обрезан чуть ниже ряда кнопок макета телефона:
        // ФИО, номер школы и данные руководителя в кадр не попадают.
        slide: {
          src: "assets/images/studymate/studymate-presentation.webp",
          w: 1240, h: 571,
          alt: "Титульный слайд презентации: образовательный Telegram-бот на основе ФГОС России",
          caption: "Титульный слайд презентации проекта",
        },
      },
      {
        id: "cv-trainer",
        ...
        visual: "vision",
        shot: {
          src: "assets/images/sport/sport-trainer.webp",
          w: 960, h: 605,
          alt: "Экран ИИ-тренера: распознавание позы при отжимании, прямая линия тела, угол локтей 180°, счётчик повторений и оценка техники",
        },
      },
      {
        id: "school-bot",
        ...
        visual: "telegram",
        // Скриншотов бота нет, поэтому интерфейс собирается вектором
        // в той же палитре — проект не должен выглядеть пустым.
        mock: {
          bot: "Цифровая школа",
          aria: "Макет интерфейса Telegram-бота: диалог с ботом и меню разделов — дневник, запись, преподаватели, направления",
          user: "Что нового на неделе?",
          reply: "Выберите раздел",
          buttons: ["Дневник", "Запись", "Преподаватели", "Направления"],
        },
      },
    ],
  ...
  contact: {
    ...
    links: [
      { label: "GitHub", url: "https://github.com/last1r", mono: "GH" },
      { label: "Telegram", url: "https://t.me/last1r", mono: "TG" },
      { label: "VK", url: "https://vk.com/id605896910", mono: "VK" },
      { label: "Email", url: "mailto:artembabanin14474@gmail.com", mono: "@@" },
    ],
  },
